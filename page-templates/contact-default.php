...
?>
	...
	<!-- Google Map -->
    <div id="map" class="map" data-lat="<?php the_map('map', 'lat'); ?>" data-lng="<?php the_map('map', 'lng'); ?>">
    </div><!---/map-->
    <!-- End Google Map -->
    ...
    <div class="container content">		
    	<div class="row margin-bottom-30">
    		<div class="col-md-9 mb-margin-bottom-30">
                <?php the_conditional_field('main_title', '<div class="headline"><h2>', '</div>'); ?>
                <?php the_content(); ?>
            </div><!--/col-md-9-->
